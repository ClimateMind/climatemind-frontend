  ...
  return (
    <CmCard style={{ padding: 20 }}>
      ...
      <Collapse in={expanded && conversationState === 0}>
        <CmTypography variant='body' style={{ marginTop: 20 }}>When {USER_B_NAME} is finished, we will send you an email and their results will appear here. Then you can start preparing for your chat!</CmTypography>
