    ...
    climateEffects: [
      {
        ...
        isPossiblyLocal: 0,
        relatedPersonalValues:["security", "self-direction", "stimulation", "universalism"],
        sharedScore: 42,
      }
    ],
    climateSolutions: [
      {
        ...
        solutionShortDescription: "Tailoring your climate change message about topics or values important to people makes for a more positive and effective conversation.",
     ...
     },
     {
        ...
        solutionShortDescription: "Improved clean cookstoves can address the pollution from burning wood or biomass in traditional stoves. Using various technologies, they reduce emissions and protect human health.",
