...
export default function ChangePasswordForm({isOpenModal, onConfirm, handleClose}:{isOpenModal:boolean, onConfirm:(values:any)=>void, handleClose:()=>void}) {
    ...
    return (
        <CMModal handleClose={handleClose} disabled={!(formik.dirty && formik.isValid && passwordsMatch)} onConfirm={() => onConfirm(formik.values)} isOpen={isOpenModal}>
