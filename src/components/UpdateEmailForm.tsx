...
export default function UpdateEmailForm({isOpenModal, onConfirm, handleClose, userEmail}:{isOpenModal:boolean, onConfirm:(values:any)=>void, handleClose:()=>void, userEmail : string}) {
