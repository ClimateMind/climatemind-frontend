          ...
          <div className={classes.container}>
            ...
            <Box>
              <Typography variant="body1">
                The Theory of Basic Human Values recognizes ten
                universal values. Respond to 10 statements based on
                these to find out your core values. Then view your
                results, learn how climate change affects you now and
                explore exciting solutions.
              </Typography>
            </Box>
            ...
            <Box mt={5}>
              <Typography
                variant="body1"
                className={classes.explainerParagraph}
              >
                Read each statement and decide how much you are like
                or not like that. Don’t worry! There’s no right or
                wrong answers!
              </Typography>
            </Box>
            ...
            <Box mt={5}>
              <Button
                ...
                color="primary"
                disableElevation
                onClick={() => history.push(ROUTES_CONFIG.ROUTE_QUIZ)}
              >
                Take the quiz
              </Button>
            </Box>
        ...
        >
          <div className={classes.container}>
            <Box mt={isXs ? -3 : -12} mb={4}>
              ...
              >
                We make personalized understanding of climate change
                easier.
              </Typography>
            </Box>
            <Box mt={4} mb={4}>
