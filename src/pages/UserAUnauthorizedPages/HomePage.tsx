    ...
    <Page>
      <PageSection>
        <PageContent>
          ...
          <CmButton text="Get Started" onClick={handleGettingStarted} style={{ marginTop: 30, marginBottom: 10, zIndex: 1000 }} />
          ...
          <CmTypography variant="body" style={{ marginTop: 50, marginBottom: 20, textAlign: 'center' }}>
            Climate change affects us all. And to inspire sufficient action, we must talk about it much more.
          </CmTypography>
      ...
      <PageSection style={{ backgroundColor: '#07373b', flex: 1 }}>
        <PageContent style={{ paddingTop: 30 }}>
          <CmTypography variant="body" style={{ color: 'white', textAlign: 'center' }}>
            We use proven social science to connect climate change to what people care about and help find solutions they like.
          </CmTypography>
